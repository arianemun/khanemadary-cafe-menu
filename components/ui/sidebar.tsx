...
const SIDEBAR_WIDTH_MOBILE = "min(280px, 88vw)";
  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className={cn(
              "w-[--sidebar-width] border-white/[0.06] bg-sidebar p-0 text-sidebar-foreground shadow-xl shadow-black/25 [&>button]:hidden",
              className
            )}
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-50 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear lg:flex",
            side === "left"
